...
console.log('ExamPulse AI PYQ Database loaded successfully with ' + window.ExamPulseData.questions.length + ' questions mapped to exam categories.');
